...
My project is geared towards answering the following question: to what extent does the mental well-being of students in the United States affect their academic performance? 

```{r}
#| label: import data in this chunk
library(readxl)

test_scores <- read_excel("C:/Users/aaronskim/Documents/Math 437/Data/standardized_test_scores.xlsx") 
sad_percent <- read_excel("C:/Users/aaronskim/Documents/Math 437/Data/felt_sad_2021.xlsx") 
